  ...
  if (data.username === message_username) {
    chatBody.innerHTML += `<div class="flex justify-end mb-5 ">
                            <div class="flex flex-col max-w-[80%]">
                              <p class="mr-3 rounded-s-3xl rounded-br-lg rounded-tr-3xl hover:bg-[#00002E] hover:text-sky-300 bg-[#00002E] px-2 py-2 text-yellow-600 stext-[#ade8f4]">${escapedMessage}</p>
